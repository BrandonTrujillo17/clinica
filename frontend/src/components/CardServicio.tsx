...
import RegistrarEditarServicio from "../pages/RegistrarEditarServicio";
...
const CardServicio: React.FC<CardServicioProps> = ({ nombre, descripcion, costo, comentarios_adicionales }) => {
  ...
  const medicosDisponibles = [
    { id: 1, nombre: "Dr. Ramírez" },
    { id: 2, nombre: "Dra. Pérez" },
    { id: 3, nombre: "Dr. Sánchez" },
  ]

  const handleUpdate = (data: any) => {
    console.log("Actualizar en la base de datos:", data)
  }
